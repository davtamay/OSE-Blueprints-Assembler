...
{
    /// <summary>
    /// Custom inspector for <see cref="SessionDriver"/> (play-mode session bridge).
    /// Provides a package-ID dropdown. Edit-mode step preview is on
    /// <see cref="EditModePreviewDriverEditor"/>.
    /// </summary>
