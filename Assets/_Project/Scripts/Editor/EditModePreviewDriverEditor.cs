...
{
    [CustomEditor(typeof(EditModePreviewDriver))]
    public sealed class EditModePreviewDriverEditor : UnityEditor.Editor
    {
        ...
        private void CommitStep(SerializedProperty stepSeqProp, int newIdx)
        {
            ...
            ((EditModePreviewDriver)target).SetEditModeStep(sequenceIndex);
